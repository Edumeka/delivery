...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ route('bienvenida') }}"><img src="{{ asset('img/logo_delivery.png') }}" width="70"></a>
...
$('#btnCerrarSesion').show(); // Mostrar el botón de cerrar sesión
                ...
                document.getElementById('auth-link').setAttribute('href', '{{ route('login') }}'); // Redirige a la página de login
            }
        }

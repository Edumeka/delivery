    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if (direccionId) {
                ...
                $.ajax({
                    url: 'http://localhost:8080/delivery/v1/empresas/obtenerEmpresas/' + direccionId,  // Llama a tu API
                    type: 'GET',
                            ...
                            response.forEach(function(empresa) {
                                ...
                                let cardHtml = `
                                    <div class="col-md-4 mb-4">
                                        <div class="card">
                               <img src="${empresa.imagenUrl || defaultImageUrl}" class="card-img-top" alt="${empresa.empresa}" style="width: 50px;">
                ...
                $('#empresasCercanas').html('<p>No se ha seleccionado ninguna dirección. Por favor, seleccione una dirección primero.</p>');
            }
        });
    </script>
</x-plantilla>
